...
$$
\text{Portfolio value} = \$1,000,000 \times 1.037 = \$1,037,000 
$$
...
$$
\text{Total return} = \frac{\$1,037,000 + (-\$13,800)}{\$1,000,000} - 1 = 0.0232  
$$

$$
\text{Effective beta} = \frac{0.0232}{0.037} = 0.627
$$

- The effective $\beta = 0.627$ is pretty far from the target $0.8$, because optimal
number of contracts was $-8.421$. 
...
under management from 0.90 to 1.15 for a four-month period. The portfolio has a market
value of \$250,000,000. The investment firm plans to use a futures contract priced at
\$120,000 in order to adjust the portfolio beta. The futures contract has a beta of
1.02.
     - A. Calculate the number of futures contracts that should be bought or sold to
     achieve an increase in the portfolio beta.
     - B. At the end of four months, the overall equity market is up 6.2%. The stock
     portfolio under management is up 5.8%. The futures contract is priced at \$127,000.
     Calculate the value of the overall position and the effective beta of the
     portfolio.
2. Consider an asset manager who wishes to create a fund with exposure to the S&P 500
stock index. The initial amount to be invested is \$400,000,000. The fund will be
constructed using the S&P 500 index futures contract, priced at 2705.25 with a \$250
multiplier. The contract expires in six months. The underlying index has a dividend
yield of 1.25%, and the risk-free rate is 1.95% per year.
     - A. Indicate how the money manager would go about constructing this synthetic
     index using futures.
     - B. Assume that at expiration, the S&P 500 is at 2812.40. Show how the synthetic
     position produces the same result as investment in the actual stock index.
3. An investment management firm has a client who would like to temporarily reduce her
exposure to equities by converting a \$30 million equity position to cash for a period
of five months. The client would like this reduction to take place without liquidating
her equity position. The investment management firm plans to create a synthetic cash
position using an equity futures contract. This futures contract is priced at 1265.80,
has a multiplier of \$200, and expires in five months. The dividend yield on the
underlying index is 1.50%, and the risk-free rate is 2.25%.
     ...
     to cash.
     - C. Assume that the stock index is at 1190 when the futures contract expires. Show
     how this strategy is equivalent to investing in the risk-free asset, cash.
4. Consider a portfolio with a 60% allocation to stocks and 40% to bonds. The portfolio
has a market value of \$150 million. The beta of the stock position is 1.10, and the
modified duration of the bond position is 5.50. The portfolio manager wishes to increase
the stock allocation to 80% and reduce the bond allocation to 20% for a period of four
months. In addition to altering asset allocations, the manager would also like to
increase the beta on the stock position to 1.25 and increase the modified duration of
the bonds to 7.50. A stock index futures contract that expires in four months is priced
at \$145,000 and has a beta of 0.90. A bond futures contract that expires in four months
is priced at \$104,000 and has an implied modified duration of 4.75. The stock futures
contract has a multiplier of one.
     ...
     long or short.
     - B. After four months, the stock portfolio is up 4% and bonds are up 1.10%. The
     stock futures price is \$150,800 and the bond futures price is $105,040. Compare
...
5. A hedge fund manager expects to receive a cash inflow of \$60,000,000 in four months
and wants to use futures contracts to take a \$20,000,000 synthetic position in stocks
and \$40,000,000 in bonds today. The stock would have a beta of 1.20 and the bonds a
modified duration of 6.50. A stock index futures contract with a beta of 0.88 is priced
at \$192,500. A bond futures contract with a modified duration of 4.75 is priced at
\$110,000.
     ...
     - B. When the futures contracts expire in four months, stocks have declined by 4.3%
     and bonds have declined by 2.85%. Stock index futures are priced at \$184,372, and
     bond futures are priced at \$107,115. Show that profits on the futures positions
     are essentially the same as the change in the value of stocks and bonds during the
     four-month period.
6. Consider a US company, StreamTech, that exports technology to the European Union.
StreamTech has just closed a sale worth €250,000,000. The amount will be received in
three months. Because it will be paid in euros, the US company bears the exchange risk.
In order to hedge this risk, StreamTech intends to use a forward contract that is priced
at \$1.1725 per euro. Indicate how the company would go about constructing the hedge.
Explain what happens when the forward contract expires in three months.
7. MegaCorp is a US-based company that frequently imports electronics components from
Japan. It has just entered into a contract to purchase ¥3,000,000,000 worth of
semiconductor chips, to be paid in two months. MegaCorp fears that the Japanese yen will
strengthen, thereby raising the US dollar cost. A forward contract is available and is
priced at \$0.0091 per Japanese yen. Indicate how MegaCorp would go about constructing a
hedge. Explain what happens when the forward contract expires in two months.