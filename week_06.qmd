...
1. What is the difference between expected shortfall and VaR? What is the theoret- ical
...
independent of each other.
    ...
    - Show that, in this example, VaR does not satisfy the subadditivity condition,
    whereas expected shortfall does.
9. Suppose the first-order autocorrelation for daily changes in the value of a port-
folio is 0.12. The 10-day VaR, calculated by multiplying the one-day VaR by√10, is \$2
